...
static const _Distvel_type_support_symbol_names_t _Distvel_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, proy_eq1_custom_interface, msg, Distvel)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, proy_eq1_custom_interface, msg, Distvel)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, proy_eq1_custom_interface, msg, Distvel)() {
  return &::proy_eq1_custom_interface::msg::rosidl_typesupport_c::Distvel_message_type_support_handle;
}
