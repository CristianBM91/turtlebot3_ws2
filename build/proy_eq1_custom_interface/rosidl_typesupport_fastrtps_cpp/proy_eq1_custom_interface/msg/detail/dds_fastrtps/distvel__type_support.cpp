...
#include "proy_eq1_custom_interface/msg/detail/distvel__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const proy_eq1_custom_interface::msg::Distvel & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  proy_eq1_custom_interface::msg::Distvel & ros_message)
{
  // Member: distancia
  cdr >> ros_message.distancia;
...
{
  auto typed_message =
    static_cast<const proy_eq1_custom_interface::msg::Distvel *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<proy_eq1_custom_interface::msg::Distvel *>(
    untyped_ros_message);
...
get_message_type_support_handle<proy_eq1_custom_interface::msg::Distvel>()
{
  return &proy_eq1_custom_interface::msg::typesupport_fastrtps_cpp::_Distvel__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, proy_eq1_custom_interface, msg, Distvel)() {
  return &proy_eq1_custom_interface::msg::typesupport_fastrtps_cpp::_Distvel__handle;
}
